  ...
  const baseServices = [
    {
      ...
      description:
        "Livraison rapide et sécurisée de vos équipements électriques partout au Cameroun",
      icon: Truck,
      features: [
        "Livraison 24-48h",
        "Suivi en temps réel",
    ...
    },
    {
      ...
      description:
        "Installation professionnelle de vos équipements par nos techniciens certifiés",
      icon: Settings,
      features: [
    ...
    },
    {
      ...
      description:
        "Formations spécialisées pour maîtriser vos équipements électriques",
      icon: GraduationCap,
      features: [
    ...
    },
    {
      ...
      description:
        "Accompagnement expert pour vos projets électriques et énergétiques",
      icon: Users,
      features: [
        "Audit technique",
        "Dimensionnement",
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-primary-foreground/80 mb-8">
                Des solutions complètes pour tous vos besoins en matériel
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Découvrez nos quatre services de base qui couvrent tous vos
                besoins en matériel électrique
              </p>
            </div>
              ...
              {additionalServices.map((service, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent>
                      {service.status !== "Bientôt disponible" ? (
                        <Badge
                          variant={
                            service.status === "Nouveau"
                              ? "default"
                      ...
                      <Button
                        variant="outline"
                        className="w-full"
                        disabled={service.status === "Bientôt disponible"}
                      >
                        {service.status === "Bientôt disponible"
                          ? "Bientôt disponible"
                          : "Demander un devis"}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Une approche structurée pour garantir la qualité de nos
                interventions
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Étude détaillée de votre projet et de vos contraintes",
                },
                {
                  step: "02",
                  title: "Proposition technique",
                  description:
                    "Élaboration d'une solution adaptée avec devis détaillé",
                },
                {
                  step: "03",
                  title: "Mise en œuvre",
                  description:
                    "Réalisation par nos équipes certifiées selon planning convenu",
                },
                {
                  step: "04",
                  title: "Suivi & maintenance",
                  description:
                    "Accompagnement post-installation et service après-vente",
                },
              ].map((item, index) => (
                <div key={index} className="text-center">
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Nos services sont disponibles dans les principales villes du
                Cameroun
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                {
                  region: "Nord",
                  cities: ["Garoua", "Maroua", "Ngaoundéré"],
                  coverage: "70%",
                },
                {
                  region: "Nord-Ouest",
                ...
                },
                {
                  ...
                  cities: ["Sur demande", "Devis personnalisé"],
                  coverage: "50%",
                },
              ].map((zone, index) => (
                <Card key={index}>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="secondary" title="Taux de couverture">
                        {zone.coverage}
                      </Badge>
                    </div>
                  </CardHeader>
