  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Service de livraison très professionnel. Mes commandes arrivent toujours en parfait état et dans les délais annoncés.",
      city: "Douala",
    },
    {
      name: "Marie NGUYEN",
      ...
      rating: 5,
      comment:
        "Excellente réactivité ! Commande passée le matin, livrée le lendemain sur mon chantier à Yaoundé.",
      city: "Yaoundé",
    },
    {
      name: "Paul BIYA Jr",
      ...
      rating: 4,
      comment:
        "Très satisfait de la livraison express. L'équipe de livraison est courtoise et professionnelle.",
      city: "Bafoussam",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Emballage professionnel et assurance complète pour tous vos équipements",
    },
    {
      icon: Route,
      title: "Suivi en Temps Réel",
      description:
        "Suivez votre commande étape par étape avec notre système de tracking",
    },
    {
      icon: Calendar,
      title: "Livraison Programmée",
      description:
        "Planifiez votre livraison selon vos disponibilités et contraintes",
    },
    {
      icon: Users,
      title: "Équipe Spécialisée",
      description:
        "Livreurs formés à la manipulation d'équipements électriques sensibles",
    },
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-primary-foreground/80 mb-8">
                  ...
                  partout au Cameroun avec notre service de livraison
                  professionnel.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Choisissez l'option qui correspond le mieux à vos besoins et
                contraintes
              </p>
            </div>
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Découvrez nos zones de couverture et les délais de livraison
                associés
              </p>
            </div>
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-4 h-4 rounded-full ${zone.color}`}
                      ></div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Un service de livraison conçu spécialement pour les
            ...
            <Card className="bg-primary text-primary-foreground">
              <CardContent className="p-8">
                ...
                <p className="text-primary-foreground/80 mb-6 max-w-2xl mx-auto">
                  Passez votre commande maintenant et bénéficiez de notre
