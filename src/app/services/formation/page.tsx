...
export default function FormationServicePage() {
  ...
  const formations = [
    {
      ...
      popular: false,
      nextDate: '2024-02-15',
      description: 'Formation complète aux fondamentaux de l\'électricité pour les débutants',
      objectives: [
    ...
    },
    {
      ...
      popular: true,
      nextDate: '2024-02-20',
      description: 'Formation spécialisée pour les installations électriques industrielles',
      objectives: [
  ...
  const formationCategories = [
    ...
    { name: 'Débutant', count: formations.filter(f => f.level === 'Débutant').length, filter: 'Débutant' },
    { name: 'Intermédiaire', count: formations.filter(f => f.level === 'Intermédiaire').length, filter: 'Intermédiaire' },
    { name: 'Avancé', count: formations.filter(f => f.level === 'Avancé').length, filter: 'Avancé' },
    { name: 'Tous niveaux', count: formations.filter(f => f.level === 'Tous niveaux').length, filter: 'Tous niveaux' }
  ];
  ...
  const instructors = [
    ...
    },
    {
      ...
      experience: '12 ans',
      specialties: ['Automatismes', 'Haute tension', 'Maintenance industrielle'],
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Formation exceptionnelle ! J\'ai acquis des compétences que j\'utilise quotidiennement. Les formateurs sont très compétents et la pratique est vraiment enrichissante.',
      date: '2024-01-15',
    ...
    },
    {
      ...
      rating: 5,
      comment: 'Excellente formation ! J\'ai pu installer mon premier système domotique dès la semaine suivante. Le support pédagogique est de qualité.',
      date: '2024-01-10',
    ...
    },
    {
      ...
      rating: 5,
      comment: 'Formation très complète sur le solaire. J\'ai maintenant les compétences pour dimensionner et installer des systèmes photovoltaïques.',
      date: '2024-01-08',
  ...
  const faqs = [
    {
      ...
      answer: 'Vous pouvez vous inscrire en ligne via notre formulaire, par téléphone au +237 6 12 34 56 78, ou en vous rendant dans nos centres. Un acompte de 30% est demandé pour confirmer l\'inscription.',
      category: 'inscription'
    },
    {
      id: '2',
      question: 'Les formations sont-elles certifiantes ?',
      answer: 'Oui, toutes nos formations délivrent une certification reconnue par l\'État du Cameroun et les entreprises du secteur. Un examen final valide l\'acquisition des compétences.',
      category: 'certification'
    },
    {
      id: '3',
      question: 'Proposez-vous des formations en entreprise ?',
      answer: 'Absolument ! Nous proposons des formations sur mesure dans vos locaux pour les groupes de 8 personnes minimum. Contactez-nous pour un devis personnalisé.',
      category: 'entreprise'
    },
    {
      id: '4',
      question: 'Que comprend le prix de la formation ?',
      answer: 'Le prix inclut : la formation, les supports pédagogiques, les équipements pratiques, les pauses café, le déjeuner et la certification. Seul l\'hébergement n\'est pas inclus.',
      category: 'tarif'
    },
    {
      id: '5',
      question: 'Quels sont les horaires des formations ?',
      answer: 'Les formations se déroulent généralement de 8h à 17h avec une pause déjeuner d\'1h. Pour les formations du soir, c\'est de 18h à 21h.',
      category: 'planning'
    },
    {
      id: '6',
      question: 'Y a-t-il un suivi après la formation ?',
      answer: 'Oui, nous proposons un suivi de 3 mois avec support technique gratuit par email et téléphone pour vous accompagner dans l\'application des compétences acquises.',
      category: 'suivi'
    }
  ];
  ...
  const centers = [
    {
      ...
      equipment: ['8 postes de travail', 'Vidéoprojecteur', 'Matériel pratique', 'Connexion WiFi']
    },
    {
      ...
      equipment: ['10 postes équipés', 'Laboratoire électrique', 'Atelier pratique', 'Parking sécurisé']
    },
    {
      ...
      equipment: ['Installation solaire', 'Équipements industriels', 'Salle climatisée']
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-primary-foreground/80 mb-8">
                  Développez vos compétences en électricité avec nos formations certifiantes 
                  dispensées par des experts reconnus. De l'initiation à la spécialisation avancée.
                </p>
                ...
                <div className="bg-primary-foreground/10 rounded-2xl p-8">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div className="bg-primary-foreground/20 rounded-lg p-4">
                      ...
                      <div className="text-sm text-primary-foreground/80">Formés/an</div>
                    </div>
                    <div className="bg-primary-foreground/20 rounded-lg p-4">
                    ...
                    <div className="bg-primary-foreground/20 rounded-lg p-4">
                      ...
                      <div className="text-sm text-primary-foreground/80">Formateurs</div>
                    </div>
                    <div className="bg-primary-foreground/20 rounded-lg p-4">
                      <MapPin className="w-8 h-8 mx-auto mb-2" />
                      <div className="text-2xl font-bold">3</div>
                      <div className="text-sm text-primary-foreground/80">Centres</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                6 formations spécialisées pour développer vos compétences techniques, 
                du niveau débutant aux technologies avancées
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
              {formations.map((formation, index) => (
                <Card key={index} className={`relative hover:shadow-xl transition-all duration-300 ${formation.popular ? 'ring-2 ring-primary' : ''}`}>
                  {formation.popular && (
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardTitle className="text-xl mb-2">{formation.name}</CardTitle>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span>Prochaine: {new Date(formation.nextDate).toLocaleDateString('fr-FR')}</span>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-2">
                        {formation.objectives.slice(0, 4).map((objective, i) => (
                    ...
                    {selectedFormation === formation.id && (
                      <div className="space-y-4 border-t pt-4">
                        <div>
                          <h4 className="font-semibold mb-2">Programme détaillé</h4>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="space-x-2">
                        ...
                        <Button size="sm" variant={formation.popular ? "default" : "outline"}>
                          S'inscrire
                        </Button>
                      </div>
                    </div>
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Notre Équipe de Formateurs</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Des experts reconnus du secteur avec une expérience terrain et pédagogique confirmée
              </p>
            </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="text-sm">
                      <div className="flex items-center justify-center space-x-2 mb-2">
                        ...
                        <span className="font-medium">{instructor.experience} d'expérience</span>
                      </div>
                    </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Nos Centres de Formation</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                3 centres équipés avec du matériel professionnel pour une formation de qualité
              </p>
            </div>
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Témoignages de Participants</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Découvrez les retours de nos stagiaires et leur progression professionnelle
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <Card className="bg-primary text-primary-foreground">
              <CardContent className="p-8">
                <h2 className="text-3xl font-bold mb-4">Développez Vos Compétences Aujourd'hui</h2>
                <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
                  Rejoignez plus de 500 professionnels formés chaque année et boostez votre carrière 
                  avec nos formations techniques reconnues.
                </p>
